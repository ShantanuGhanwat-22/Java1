    ...
    <div class="row">
        ...
        <div class="row well col-md-offset-4 col-md-8 center">
		               ...
		               <div>
						   ...
						   <div>
						      ...
						      <br><br><br>
						          ...
						          <br>
							      <a href="tokenazationFB.jsp"><button type="button" class="btn btn-primary" style="width:140px">Tokenization</button></a><br>
							      <br>
							      <a href=""><button type="button" class="btn btn-primary" style="width:140px">Stop Word Removal</button></a><br>
							      <br>
		 ...
		 StringBuilder reply=new StringBuilder();
		 	...
		 	ResultSet rs=st.executeQuery("select * from tbl_fbdata");
			while(rs.next())
			{
		 ...
		 session.setAttribute("msgstring", tmp);
		 out.print(msg);
