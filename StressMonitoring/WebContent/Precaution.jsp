        ...
        <%} %>
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="user_home.jsp"><i class="glyphicon glyphicon-home"></i><span> Home</span></a>
                                    ...
                                    class="glyphicon glyphicon-user"></i><span>Twitter Tweets Classification</span></a></li>
...
%>
		               ...
		               <div>
						   ...
						   <div>
						      ...
						      <br><br><br>
						          ...
						          <br>
						          <!-- <a href="Precaution.jsp"><button type="button" class="btn btn-primary" style="width:140px">View Precautions</button><br></a>
						        <br> -->
							     
							      <a href="UserLogoutController"><button type="button" class="btn btn-primary" style="width:140px">Logout</button></a><br>
							      <br>
							      <br>
							  </div>			
						   </div>
		...
		System.out.println("precaution>>>>>>>>>"+pre);
		Connection con=ConnectionUtils.getConnection();
		Statement smt=con.createStatement();
		ResultSet rs=smt.executeQuery("SELECT * from tbl_precautions where type='"+pre+"'");
		while(rs.next())
		{
		
			
			out.println("Precaution: "+rs.getString(3));
			%>
			<br>
			<br>
