...
<div class="ch-container">
	...
	<div class="row">        
		...
		%>
            ...
            <h2 align="center">Collect Facebook Data</h2>
        </div>
        <!--/span-->
    ...
    <div class="row">
        <div class="well col-md-4 center login-box">
            ...
            <form action="AddTokenController" method="post">
                <fieldset>
                    ...
                    <p class="left col-md-7">
                        <a href="HowToAdd.jsp" class="btn btn-primary">How to Fetch Facebook Data</a>
                   </p>
