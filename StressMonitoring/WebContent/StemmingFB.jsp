...
%>
		               ...
		               <div>
						   ...
						   <div>
						      ...
						      <br><br><br>
							      ...
							      <a href="FBCalculateResultController"><button type="button" class="btn btn-primary" style="width:140px">Classification</button></a><br>
							      <br>
		...
		<% 
String stemmingMsg=(String)session.getAttribute("stemmingResult");
out.println(stemmingMsg);
session.setAttribute("msgStemmingResult", stemmingMsg);
%>
